...
Supplementary Figure 2f, left: Run `flywire_graph_traversal.ipynb` with different sets of seed neurons. 

Supplementary Figure 2f, right: Run `flywire_shortest_path.ipynb`.
...
Figure 4g: Same as Figure 4f, but with `dataset = treadmill_ephys_rrn_gfp_flight.mat`.
...
Figure 4h, right: Same as Figure 4h left, but with `dataset = treadmill_ephys_rrn_gfp_flight.mat`.
