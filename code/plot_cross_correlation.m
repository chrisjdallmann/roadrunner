...
ephys_parameter_name = 'spike_rate'; % 'membrane_potential', 'spike_events', 'spike_rate'
...
for animal_id = animal_ids_to_include
    ...
    for trial = 1:n_trials
        ...
        % Select data during movement
        %ephys_data = ephys_data(movement_data==1);
        %treadmill_data = treadmill_data(movement_data==1);
